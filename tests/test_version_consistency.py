...
# HAVING NO CHANGELOG AT ALL (found in ShellyDirect, 08-09-2026). This repo
# writes its entries as "- **v3.18.0** — ...", the pattern required them to
# start the line, nothing matched, and the check SKIPPED — so the README
# changelog sat three releases behind with a test watching it and reporting
# green. Allowing the marker is a strict widening: it can only turn a skip into
# a real check, never the reverse.
